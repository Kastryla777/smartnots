...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.textEdit.setGeometry(QtCore.QRect(0, 0, 271, 401))
        self.textEdit.setObjectName("textEdit")
        self.verticalLayoutWidget = QtWidgets.QWidget(parent=self.centralwidget)
        self.verticalLayoutWidget.setGeometry(QtCore.QRect(290, 0, 311, 401))
        ...
        self.horizontalLayout_2.addWidget(self.del_tag)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.save_note.setText(_translate("MainWindow", "Зберегти нотатку"))
        ...
        self.del_tag.setText(_translate("MainWindow", "Видалити тег"))
        self.search_btn.setText(_translate("MainWindow", "шукати нотатки по тегу"))
